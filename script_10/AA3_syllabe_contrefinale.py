    ...
    def syllabe_contrefinale(self, object):
        ...
        if syllabes[-4][0] in listes_lettres['consonnes_et_semi_consonnes']:
            ...
            if syllabes[-4][0] == 'B':
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    #En position intiale, tout élément consonantique complexe constitué d'une consonne et d'une liquide demeure intact
                        ...
                        if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                            ...
                            if syllabes[-5][-1] == 'Ę' and syllabes[-3][0] == 'Y':
                ...
                #Consonantisme simple
                    ...
                    if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                        ...
                        if syllabes[-4][1] in ['A', 'Á', 'Ẹ', 'Ę', 'E', 'Í']:
                            if syllabes[-4][-1] == 'Ú':
                                changements.append('')
                            else:
            ...
            #Gestion de C
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-4][1] == 'L':
                        ...
                        if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                            if syllabes[-5][-1] in ['Í']:
                                changements.append('r')
                            elif syllabes[-5][-1] == 'Á':
                                changements.append('gr')
                            else:
                                changements.append('ir')
                        elif syllabes[-5][-1] in ['R', 'S']:
                ...
                #Consonantisme simple
                    ...
                    #Consonantisme explosif
                        ...
                        if syllabes[-5][-1] in ['L', 'M']:
                            changements.append('c')
                        #Palatalisation de C devant A
                        elif syllabes[-4][1] in ['A', 'Á']:
                            changements.append('ch')
                        elif syllabes[-5][-2] + syllabes[-5][-1] in ['ĘY', 'ǪY']:
                            changements.append('s')
                        elif syllabes[-5][-1] == 'Y' and syllabes[-4][1] == 'Ę':
                            changements.append('s')
                        else:
                            changements.append(syllabes[-4][0])
            ...
            #Gestion de D
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                        ...
                        if len(syllabes[-4]) > 2 and syllabes[-4][1] in listes_lettres['voyelles_atones_sans_A'] and syllabes[-4][2] == 'S':
            ...
            #Gestion de G
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-4][1] == 'L':
                        if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                            if syllabes[-5][-1] in ['A', 'Á'] and syllabes[-4][2] in ['A', 'Á']:
            ...
            #Gestion de L
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    #Épenthèse d'un D après N
                        ...
                        if syllabes[-5][-2] == 'Í':
                            changements.append('g' + syllabes[-4][0])
                        else:
                            changements.append('d' + syllabes[-4][0])
                    #Épenthèse d'un D après N mouillé
                    elif len(syllabes[-5]) > 1 and syllabes[-5][-2] + syllabes[-5][-1] == 'NY':
                        changements.append('d' + syllabes[-4][0])
                    #Épenthèse d'un D après L
                    elif syllabes[-5][-1] == 'L':
                        if syllabes[-5][-2] == 'Ę' and syllabes[-4][1] == 'A':
                            changements.append('ll')
                        else:
                            changements.append('d' + syllabes[-4][0])
                    #Épenthèse d'un D après L mouillé
                    elif len(syllabes[-5]) > 1 and syllabes[-5][-2] + syllabes[-5][-1] == 'LY':
                        changements.append('d' + syllabes[-4][0])
                    #Épenthèse d'un D après une sifflante sonore
                    elif syllabes[-5][-1] == 'Z':
                        changements.append('d' + syllabes[-4][0])
                    #Épenthèse d'un T après une sifflante sourde
                    elif syllabes[-5][-1] in ['S', 'X']:
                        if syllabes[-5][-2] in ['Ę', 'Í']:
                            changements.append('l')
                        else:
                            changements.append('t' + syllabes[-4][0])
                    #Mouillure de L
                    elif syllabes[-5][-1] == 'Y':
                        if syllabes[-5][-2] == 'A' and syllabes[-4][1] == 'Í':
                            changements.append('ll')
                        else:
                            changements.append('l')
                    else:
            ...
            #Gestion de M
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-5][-1] == 'Ǫ' and syllabes[-4][1] == 'E':
            ...
            #Gestion de N
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    if syllabes[-4][1] + syllabes[-4][2] == 'GR':
                        changements.append('ndre')
                    elif syllabes[-4][1] + syllabes[-4][2] == 'CR':
            ...
            #Gestion de P
                ...
                #Consonantisme simple
                    ...
                    if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                        ...
                        if syllabes[-4][1] in ['A', 'Á', 'Ẹ']:
                            changements.append('v')
                        elif syllabes[-5][-1] == 'Ǫ' and syllabes[-4][1] == 'U':
                            changements.append('')
                        elif syllabes[-4][1] == 'Ę':
            ...
            #Gestion de R
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    if syllabes[-4][-1] == 'R':
                        changements.append('R' + syllabes[-4][1])
                    else:
                        changements.append(syllabes[-4][1])
                else:
                    #Épenthèse d'un B après M
            ...
            #Gestion de S
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-4][2] in listes_lettres['consonnes_et_semi_consonnes']:
                        changements.append(syllabes[-4][0] + syllabes[-4][1] + syllabes[-4][2])
                    else:
                        if syllabes[-4][1] == 'R':
                    ...
                    #Double ss
                    if (syllabes[-5][-1] in ['A', 'Á' ] and syllabes[-4][1] in ['A','Á']) or (syllabes[-5][-2] + syllabes[-5][-1] in ['AY', 'ÁY'] and syllabes[-4][1] in ['A', 'Á']):
                        changements.append('ss')
                    #Double SS
                    elif len(syllabes[-5]) > 1 and syllabes[-5][-2] + syllabes[-5][-1] in ['ES', 'ẸS'] and syllabes[-4][1] == 'A':
                        changements.append('ss')
                    else:
                        changements.append(syllabes[-4][0])
            ...
            #Gestion de T
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    #En position intiale, tout élément consonantique complexe constitué d'une consonne et d'une liquide demeure intact
                        ...
                        if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                            if syllabes[-5][-1] in ['E', 'O'] and syllabes[-4][2] in ['Á', 'Í']:
                                changements.append('rr')
                            else:
                                cchangements.append('r')
                        else:
                            changements.append(syllabes[-4][0] + syllabes[-4][1])
                    elif syllabes[-4][1] == 'S':
                    ...
                    #La palatale se combine avec le yod pour se stabiliser dans une zone un peu plus avancée que celle de sa sononre correspondante
                        ...
                        if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                            ...
                            if syllabes[-4][2] in ['A', 'O', 'Ọ', 'Ǫ']:
                                changements.append('ç')
                            elif syllabes[-3][0] in ['A', 'O', 'Ọ', 'Ǫ']:
                                changements.append('ç')
                            else:
                                changements.append('c')
                    else:
                    ...
                    if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles']:
                        ...
                        if len(syllabes[-4]) > 2 and syllabes[-4][1] in listes_lettres['voyelles_atones_sans_A'] and syllabes[-4][2] == 'S':
                            changements.append('t')
                        elif len(syllabes[-5]) > 1 and syllabes[-5][0] + syllabes[-5][1] in listes_lettres['consonantisme_implosif_complexe_2_lettres']:
                            changements.append('t')
                        #Amuïssement de la dentale en milieu intervocalique
                        else:
                            changements.append('')
                    #Consonantisme explosif
                        ...
                        if syllabes[-5][-2] + syllabes[-5][-1] == 'ǪY' and syllabes[-4][1] == 'Á':
                            changements.append('d')
                        else:
                            changements.append(syllabes[-4][0])
            ...
            #Gestion de W
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-4][1] in ['Ẹ', 'Ú']:
                        changements.append('')
                    elif len(syllabes[-5]) > 1 and syllabes[-5][-2] + syllabes[-5][-1] == 'ĘY' and syllabes[-4][1] == 'A':
                        changements.append('v')
                    else:
                        changements.append('g')
            ...
            #Gestion de X
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    ...
                    if syllabes[-5][-1] in listes_lettres['toutes_les_voyelles'] and syllabes[-4][1] in listes_lettres['toutes_les_voyelles']:
                        if syllabes[-5][-1] == 'A' and syllabes[-4][1] == 'Ī':
            ...
            #Gestion de Y
                ...
                if syllabes[-4][1] in listes_lettres['consonnes_et_semi_consonnes']:
                    if syllabes[-4][1] == 'C':
                        if syllabes[-4][2] in ['A', 'Á']:
                            changements.append('ch')
                        #Spirantisation
                        elif syllabes[-5][-2] + syllabes[-5][-1] == 'ĘD':
                            changements.append('r')
                        elif syllabes[-5][-2] + syllabes[-5][-1] in ['ẸN', 'ỌN']:
                            changements.append('')
                        else:
                            changements.append('c')
                    #Épenthèse d'un D après L
                    ...
                    #Spirantisation
                        ...
                        changements.append('g')
                    #Le reste
                    elif syllabes[-4][1] in ['C', 'Ę', 'G', 'Í', 'L', 'N', 'Ǫ', 'Ọ', 'R', 'S', 'Y']:
                        changements.append('')
                    else:
                        changements.append('i')
        ...
        if 'A' in syllabes[-4]:
            ...
            #Si A se trouve en position ouvert
                ...
                #Cas de suffixation
                if syllabes[-5][-1] == ' ':
                    #Contacte avec un élément triple (consonne + liquide + semi-voyelle)
                    if syllabes[-3] + syllabes[-2][0] == 'TRY':
                        changements.append('ai')
                    else:
                        changements.append('a')
                elif len(syllabes[-4]) > 2 and syllabes[-4][-3] + syllabes[-4][-2] == 'TY':
            ...
            #Si A se trouve au milieu de la syllabe
                ...
                #Préfixe
                if syllabes[-4][-1] + syllabes[-3][0] + syllabes[-3][1] + syllabes[-2][0] == 'STRY':
                    changements.append('ai')
                elif syllabes[-5] == syllabes[0] == 'EM':
                    changements.append('a')
                #En cas de hiatus avec la tonique précédente, la voyelle devient tonique
                elif syllabes[-4][-2] == syllabes[-4][0] and syllabes[-5][-1] in listes_lettres['voyelles_toniques']:
                    changements.append('a')
                elif syllabes[-4][-1] in ['M', 'N']:
                    changements.append('a')
                elif syllabes[-4][-1] + syllabes[-3][0] == 'TY':
                    changements.append('ai')
                elif syllabes[-4][-1] == 'W':
        ...
        #E
            ...
            #Si E se trouve au milieu de la syllabe
                ...
                #En cas de hiatus avec la tonique précédente, la voyelle devient tonique
                if syllabes[-4][-2] == syllabes[-4][0] and syllabes[-4][-1] in listes_lettres['voyelles_toniques']:
                    changements.append('e')
                else:
                    changements.append('')
            #Tous les autres cas de figure
        ...
        #I
            ...
            #Si I se trouve au milieu de la syllabe
                ...
                #En cas de hiatus avec la tonique précédente, la voyelle devient tonique
                if syllabes[-4][-2] == syllabes[-4][0] and syllabes[-5][-1] in listes_lettres['voyelles_toniques']:
                    changements.append('i')
                else:
                    changements.append('')
            #Tous les autres cas de figure
        ...
        if 'Á' in syllabes[-4]:
            ...
            if len(syllabes[-4]) == 1:
                ...
                if syllabes[-3][0] in listes_lettres['toutes_les_voyelles']:
                    changements.append('')
            ...
            #Si A tonique se trouve en position ouverte
                ...
                elif syllabes[-3][0] + syllabes[-3][1] == 'CL':
                    changements.append('a')
                #Loi de Bartsch
                elif syllabes[-4][-2] in ['X', 'C']:
                    if syllabes[-5][-1] == 'O':
                        changements.append('e')
                    else:
                        changements.append('ie')
                ...
                #Présence d'un yod antéposé
                    ...
                    changements.append('ie')
                elif len(syllabes[-4]) > 2 and syllabes[-4][-3] == 'Y':
                    changements.append('ie')
                else:
                    changements.append('e')
            #Si A tonique se trouve au milieu de la syllabe
                ...
                #Fermeture devant R
                    ...
                    elif syllabes[-3][0] not in listes_lettres['toutes_les_voyelles']:
                        if syllabes[-4][0] == 'V':
                            changements.append('ai')
                        else:
                            changements.append('ie')
        ...
        #Ę ouvert
            ...
            if len(syllabes[-4]) == 1:
                ...
                elif len(syllabes[-3]) >= 2 and syllabes[-3][0] + syllabes[-3][1] in ['BY', 'VY', 'DY', 'GY', 'GI', 'GE']:
                    changements.append('i')
                #Au contact d'un élément ou d'un groupe consonantique comportant ou dégageant un yod
                elif len(syllabes[-3]) >= 2 and syllabes[-3][0] + syllabes[-3][1] in ['XI', 'ST', 'CT', 'SY', 'XY',]:
                    changements.append('i')
                else:
                    changements.append('ie')
            elif syllabes[-4][-1] == 'Ę':
                ...
                elif len(syllabes[-4]) > 2 and syllabes[-4][-3] + syllabes[-4][-2] == 'GN':
                    changements.append('e')
                else:
                    changements.append('ie')
            elif syllabes[-4][-2] == 'Ę':
                ...
                if syllabes[-4][-1] == 'Y':
                    changements.append('i')
                #Au contact d'un élément ou d'un groupe consonantique comportant ou dégageant un yod
                elif syllabes[-4][-1] + syllabes[-3][0] in ['XI', 'ST', 'CT', 'SY', 'XY',]:
                    changements.append('i')
                #Influence fermante d'un wau
                elif syllabes[-3][-1] + syllabes[-3][0] == 'QW':
        ...
        #Ọ fermé
            ...
            if len(syllabes[-4]) == 1:
                ...
                #Au contact d'un yod géminé provenant de BY, VY, DY, GY, GI et GE
                    ...
                    changements.append('ui')
                #Au contact d'un élément ou d'un groupe consonantique comportant ou dégageant un yod
                elif len(syllabes[-3]) >= 2 and syllabes[-3][0] + syllabes[-3][1] in ['XI', 'CT', 'ST', 'SY', 'XY',]:
                    changements.append('ui')
                else:
                    changements.append('ou')
            elif syllabes[-4][-1] == 'Ọ':
                ...
                #Au contact d'un élément ou d'un groupe consonantique comportant ou dégageant un yod
                    ...
                    if syllabes[-4][-1] == 'N':
                        ...
                        changements.append('ui')
                #Au contact d'un élément ou d'un groupe consonantique comportant ou dégageant un yod
                elif syllabes[-4][-1] + syllabes[-3][0] in ['XI', 'CT', 'ST', 'SY', 'XY',]:
                    if syllabes[-5][-1] == syllabes[0][-1] == 'A' or syllabes[-5][-2] == 'A':
                        changements.append('o')
                    else:
                        changements.append('ui')
                #Au contact d'un n mouillé
                elif syllabes[-4][-1] + syllabes[-3][0] in ['GN', 'NG']:
                    changements.append('oi')
                else:
                    changements.append('o')
            else:
        ...
        #Ǫ ouvert
            ...
            if len(syllabes[-4]) == 1:
                ...
                #Au contact d'un géminé provenant de BY, VY, DY, GY, GI et GE
                    ...
                    changements.append('ui')
                #Au contact d'un élément ou d'un groupe consonantique comportant ou dégageant un yod
                elif len(syllabes[-3]) >= 2 and syllabes[-3][0] + syllabes[-3][1] in ['XA', 'XI', 'CT', 'SY', 'XY', 'ST']:
                    changements.append('ui')
                else:
                ...
                #Au contact d'un N mouillé
                if syllabes[-4][-1] + syllabes[-3][0] in ['GN', 'NG']:
                    changements.append('oi')
                else:
                    changements.append('o')
            else:
        ...
        if syllabes[-4][-1] in listes_lettres['consonnes_et_semi_consonnes']:
            ...
            #Gestion de G
                ...
                if syllabes[-4] == 'RG':
                    changements.append('')
                #à voir
                elif syllabes[-4][-2] in ['E', 'I']:
                    changements.append('i')
                elif syllabes[-4][-2] in ['A', 'Á', 'O', 'U']:
                    changements.append('u')
                else:
                    changements.append('')
            ...
            #Gestion de R
                ...
                if syllabes[-4] in ['BR', 'CR', 'FR', 'MR', 'SR', 'TR']:
                    changements.append('')
            ...
            #Gestion de S
                ...
                if syllabes[-3][0] == 'S':
                    if syllabes[-4][-2] == 'A' and syllabes[-4][1] == 'A':
                        changements.append('s')
                    else:
                        changements.append('')
                else:
            ...
            #Gestion de T
                ...
                if syllabes[-4][-2] in ['A', 'Á'] and syllabes[-3][0] == 'Y':
                    changements.append('s')
                    """
