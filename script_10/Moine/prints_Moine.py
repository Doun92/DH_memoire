...
print(EvolutionPhonetique.evolution_phonetique("DEVỌTAMẸNTE")) # devotement
...
print(EvolutionPhonetique.evolution_phonetique("MATÍNAS")) # matines
...
print(EvolutionPhonetique.evolution_phonetique("MẸNESTERYU")) # mester
